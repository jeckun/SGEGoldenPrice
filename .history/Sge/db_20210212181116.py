...
from lib.db import Base, Engine, BaseTable, Column, Integer, Float, String, Text, Date, DateTime


class TimeSharingChart(Base, BaseTable, Engine):
...
class Trade(Base, BaseTable, Engine):
