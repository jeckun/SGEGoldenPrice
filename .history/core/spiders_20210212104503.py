...
class Spider:
    ...
    def load(self, url=None, headers=None, cookies=None):
        if url:
            return self.load_by_params(url=url, params=None, headers=None, cookies=None)
        else:
            return self.load_by_params(url=self.module.url, params=None, headers=None, cookies=None)
